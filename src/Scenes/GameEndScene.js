...
export default class GameEndScene extends Phaser.Scene {
    ...
    create () {
        ...
        this.gameEndText = this.add.text(250, 150, 'Game End.', { fontSize: '56px', fill: '#ff0000' });
        this.playerScores = this.add.text(50, 250, `Your ${realname2} Scores: ${realScores}`, { fontSize: '40px', fill: '#FFF' });
