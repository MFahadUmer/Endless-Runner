...
export default class GameScene extends Phaser.Scene {
  ...
  addCoin(){
    this.coins = this.physics.add.sprite(Phaser.Math.Between(400, 800), 400, 'coins');
  ...
  create(){
    ...
    var mainGround = this.add.tileSprite(400, 550, config.width, 100, 'platform');
    this.ground = this.physics.add.existing(mainGround, true);
    this.scoresText = this.add.text(16, 16, 'score: 0', { fontSize: '32px', fill: '#FFF' });
    this.jumpCount = 0;
