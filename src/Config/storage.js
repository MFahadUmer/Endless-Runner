...
const playerScoresModule = (() => {
    ...
    const displayScores = () => {
        const playerCurrentScores = localStorage.getItem('scores', JSON.stringify((playerScores)));
        localStorage.setItem('scores', JSON.stringify(playerScores));
    ...
    const displayPlayerName = () => {
        const currentPlayrName = localStorage.getItem('name', JSON.stringify((playerName)));
        localStorage.setItem('name', JSON.stringify(playerName));
        return currentPlayrName;
    }

    return {addScores, displayScores, displayPlayerName, addPlayerName}
})();
